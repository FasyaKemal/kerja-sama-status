const fs = require('fs');
const text = fs.readFileSync('/Users/kemalfasya/Documents/Antigravity AI/Dashboard Kinerjaku/kebijakan.csv', 'utf8');
...
fs.writeFileSync('/Users/kemalfasya/Documents/Antigravity AI/Dashboard Kinerjaku/app/js/pages/kebijakan_prioritas.js', content);
console.log('Updated with user CSV');
