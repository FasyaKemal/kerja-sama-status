                    ...
                    <tr key={r.id} style={{ borderBottom: '1px solid var(--neutral-100)' }}>
                      ...
                      <td style={{ padding: '20px 16px', verticalAlign: 'middle', textAlign: 'right' }}>
                        <div style={{ display: 'flex', gap: '6px', justifyContent: 'flex-end' }}>
                          ...
                          <button className="btn btn-ghost btn-sm" style={{ background: '#fff5f5', border: '1px solid #fed7d7', color: 'var(--red-500)', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={() => deleteItem(r.id)} title="Hapus Data">
