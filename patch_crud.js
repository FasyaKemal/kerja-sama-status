...
// 1. Add formatDateForInput and formatDateForSave helpers
const helpers = `
...
if (!content.includes('KebijakanPrioritasPage.openForm()') && !content.includes('+ Tambah Data')) {
...
console.log('Patched CRUD successfully');
